...
app.get('/person/:id', function (req, res) {
    ...
    session
        ...
        .then(function (result) {
            ...
            session
                .run("OPTIONAL MATCH (a:Person)-[r:BORN_IN]-(b:Location) WHERE id(a)=toInt({idParam}) RETURN b.city as city, b.state as state", {
                    idParam: id
                })
                .then(function (result2) {
                    ...
                    session
                        .run("OPTIONAL MATCH (a:Person)-[r:FRIENDS]-(b:Person) WHERE id(a)=toInt({idParam}) RETURN b", {
                            idParam: id
                        })
